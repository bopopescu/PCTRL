...
def set_port_iie():
    core.PofManager.set_port_of_enable(device_map["IIE"], 0x20001)   # FIXME:
    core.PofManager.set_port_of_enable(device_map["IIE"], 0x20003)  # FIXME:
...
def add_table():
    ...
    add_table_vxlan(device_map["IIE"])
