...
def broker_message (broker_type, type_val):
...
#2. Broker Messages
@broker_message("BROKER_HELLO", 0)
class broker_hello(broker_header):
...
@broker_message("BROKER_FEATURES_REPORT", 1)
class broker_features_report(broker_header):
    _MIN_LENGTH = broker_header._MIN_LENGTH
